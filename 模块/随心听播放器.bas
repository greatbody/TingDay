...
'定位当前播放的歌曲到列表
Public Sub 定位歌曲(ByRef list As ListBox, ByRef mGeJi As GeJi)
    If mGeJi.isPlay = True Then list.ListIndex = mGeJi.playWhere - 1
End Sub
'为指定歌集随机播放一首歌
